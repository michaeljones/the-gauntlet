...
export const HARDCODED_RUNS: Run[] = [
  ...
  },
  {
    ...
    source: 'hardcoded',
    timestamp: 1,
    youtubeUrl: 'https://www.youtube.com/watch?v=DQHSyJS8FdQ',
  },
  {
    id: "6",
    runNumber: 6,
    characterId: 'melusine',
    modifierIds: ['lack-of-inspiration', 'dried-up-fountains', 'corruption', 'angry-birds', 'berserker-foes'],
    outcome: 'win',
    source: 'hardcoded',
    timestamp: 1,
    youtubeUrl: 'https://www.youtube.com/watch?v=cOVf8TfWmL4',
  },
];
